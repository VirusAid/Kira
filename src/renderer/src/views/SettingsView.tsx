  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 18, maxWidth: 640 }}>
        ...
        <Toggle label="Kira видит экран"
          hint="Kira всегда в курсе, что у тебя на экране — можно спросить «что тут?» и получить ответ сразу. Смотрит только когда картинка меняется, поэтому компьютер не грузит. Всё остаётся на твоём компьютере; наружу ничего не уходит. По умолчанию выключено."
