...
**Кира — не просто чат.** Она реально *делает* вещи на твоём компьютере:
открывает программы, включает музыку, ищет, считает, наводит порядок —
голосом или текстом, быстро и по-человечески.
...
**1. Установи.** Запусти установщик **Kira Setup** — Кира появится в меню «Пуск».
Никаких дополнительных программ ставить не нужно, всё уже внутри.

**2. Подключи «мозг» (бесплатно, 2 минуты).** Чтобы Кира могла думать и разговаривать:
- зайди на [console.groq.com/keys](https://console.groq.com/keys), войди и нажми **Create API Key**;
- скопируй ключ и вставь его в Кире: **Настройки → Модели ИИ → Groq**.

Groq бесплатный, быстрый и сразу даёт распознавание голоса. Есть и другие варианты
(см. ниже), но для старта хватит его.

**3. Общайся.** Пиши в чат или включи голос и скажи **«Кира»** — она слушает.
