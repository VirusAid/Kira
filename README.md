...
## 🧠 Мозг из коробки — офлайн и приватно

**Кира думает и разговаривает сразу после установки — без ключей и без интернета.**
Внутрь встроена локальная модель **Qwen3 8B** (через Ollama): всё остаётся на твоём
компьютере, ничего не уходит в облако. На мощном GPU — быстро; на слабом железе
Кира предложит лёгкую модель. Настраивать ничего не нужно — просто работает.

*Хочешь ещё мощнее?* Можно бесплатно подключить облако (по желанию, ключ за минуту):

| Провайдер | Чем хорош | Где взять ключ |
|-----------|-----------|----------------|
| 🧠 **Локально (Qwen3)** | **Встроен, офлайн, приватно — по умолчанию** | *(ничего не нужно)* |
